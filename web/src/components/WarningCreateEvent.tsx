...
export default function WarningCreateEvent(props: Props) {
  ...
  return (
    <div className="flex flex-col p-10 bg-gray-900 text-center rounded-xl shadow-gray-950 shadow-lg drop-shadow-2xl">
      ...
      <div className="mt-5 w-full h-full flex items-center justify-center space-x-10 ">
        <button
          className="bg-green-600 hover:bg-green-500 px-6 py-2 rounded-xl shadow-gray-950 shadow-sm"
          onClick={handleSelect}
        >
          Sim
        </button>
        <button
          className="bg-red-600 hover:bg-red-500 px-6 py-2 rounded-xl shadow-gray-950 shadow-sm"
          onClick={handleClose}
        >
          Não
        </button>
